...
| 3.2  | Implement student records and attendance APIs and UI              | Authorized staff can manage EMIS-aligned student/guardian/enrollment data and mark daily attendance with tested server-side permissions                                                  | 3.1     | cc:完了 [508997f] |
| 3.3  | Implement messages and stubbed outbox delivery                    | Authorized staff can exchange persisted messages with families; deterministic delivery attempts are logged without external email/SMS                                                    | 3.2     | cc:WIP            |
| 3.4  | Implement reports and EMIS-aligned CSV exports                    | Authorized roles can generate funnel/attendance summaries and CSV exports whose fields match the approved EMIS mapping                                                                   | 3.2     | cc:WIP            |
| 3.5  | Implement administration, permissions management, and audit views | Only authorized administrators can manage staff grants, and every sensitive mutation creates a privacy-safe audit event                                                                  | 3.1     | cc:完了 [6f5d72f] |
